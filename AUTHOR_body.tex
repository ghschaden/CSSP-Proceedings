...
\begin{forest} for tree={l=10mm, l sep=0}
   ...
   \draw[-{Latex[length=2.5mm]},color=purple,ultra thick, postaction={decorate,decoration={text along path,
       text align=center,raise=-2.5ex,
       text={Because why the hell not}}}] (cellar) to[out=east,in=east]  
                        node[below, sloped] (TextNode2) (top);
\end{forest}}
