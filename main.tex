...
% Ibertinus presents a problem. Note that ONLY ONE of these three font
% options should be selected.)

%%%%%%%%%%
%% Step 2 (The title; there are potentially three substeps)
%%%%%%%%%%

%%%%%%%%%%
%% Step 2a (The title of the paper on the first page)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 2b (The title of the paper in the PDF metadata)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 2c (The title of the paper in the running headers, if different)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 3 (The authors; there are up to five substeps, depending on the
%% number of authors)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 3b (The SECOND author, if there is one; if not, go to step 5!)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 3c (The THIRD author, if there is one; if not, go to step 5!)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 3d (The FOURTH author, if there is one; if not, go to step 5!)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 3e (The FIFTH author, if there is one; if not, go to step 5!)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 4 (Linguistic examples)
%%%%%%%%%%

% We use Linguex in order to typeset linguistic examples

\UseLinguex


%%%%%%%%%%
%% Step 5 (Packages or definitions that you need)
%%%%%%%%%%
...
%%%%%%%%%%
%% Nothing more to do here -- go to step 6!
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 7 (The keywords; there are potentially three substeps)
%%%%%%%%%%

%%%%%%%%%%
%% Step 7a (Specify the keywords)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 7b (Specify the keywords in the PDF metainfo)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 7c (Specify the number of keywords)
%%%%%%%%%%
...
%%%%%%%%%%
%% Step 9 (Make the title, authors, etc.)
%%%%%%%%%%
...
%% Abbreviations
%%%%%%%%%
% If you don't need this, comment out the following line:
\MakeAbbreviations
